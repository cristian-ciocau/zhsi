...
//	public BufferedImage img_Range_Arcs;
	...
	private LoadResources() {
		...
		try {
			...
			isfdFontStream = getClass().getResourceAsStream("/Roboto-Regular.ttf");
			isfdFont = Font.createFont(Font.TRUETYPE_FONT, isfdFontStream);
			isfdThinFontStream = getClass().getResourceAsStream("/Roboto-Thin.ttf");
			isfdThinFont = Font.createFont(Font.TRUETYPE_FONT, isfdThinFontStream);
			chronoFontStream = getClass().getResourceAsStream("/CenturyGothic.ttf");
			chronoFont = Font.createFont(Font.TRUETYPE_FONT, chronoFontStream);
			chronoBFontStream = getClass().getResourceAsStream("/GOTHICB.TTF");
			chronoBFont = Font.createFont(Font.TRUETYPE_FONT, chronoBFontStream);
			chronoSegFontStream = getClass().getResourceAsStream("/DSEG7Classic-Regular.ttf");
			chronoSegFont = Font.createFont(Font.TRUETYPE_FONT, chronoSegFontStream);
			elecPanelFontStream = getClass().getResourceAsStream("/repet___.ttf");
			elecPanelFont = Font.createFont(Font.TRUETYPE_FONT, elecPanelFontStream);
			irsPanelFontStream = getClass().getResourceAsStream("/DSEG14Classic-Regular.ttf");
		...
		try {
			//PFD
			img_FMA = ImageIO.read(getClass().getResource("/pfd/img_FMA.png"));
			img_vsTape = ImageIO.read(getClass().getResource("/pfd/img_vsTape.png"));
			img_headingTrackBug = ImageIO.read(getClass().getResource("/pfd/img_headingTrackBug.png"));
//			img_headingTrackCricle = ImageIO.read(getClass().getResource("/pfd/img_headingTrackCricle.png"));
			img_headingTrack_headingMarker = ImageIO.read(getClass().getResource("/pfd/img_headingTrack_headingMarker.png"));
			img_bankIndicators = ImageIO.read(getClass().getResource("/pfd/img_bankIndicators.png"));
			img_bankPointer = ImageIO.read(getClass().getResource("/pfd/img_bankPointer.png"));
			img_bankPointer_amber = ImageIO.read(getClass().getResource("/pfd/img_bankPointer_amber.png"));
			img_speedBox = ImageIO.read(getClass().getResource("/pfd/img_speedBox.png"));
			img_altBox = ImageIO.read(getClass().getResource("/pfd/img_altBox.png"));
			img_altBox_bg = ImageIO.read(getClass().getResource("/pfd/img_altBox_bg.png"));
			img_altBox_mtrs = ImageIO.read(getClass().getResource("/pfd/img_altBox_mtrs.png"));
			img_altBox_mtrs_bg = ImageIO.read(getClass().getResource("/pfd/img_altBox_mtrs_bg.png"));
			img_green_hatch = ImageIO.read(getClass().getResource("/pfd/img_green_hatch.png"));
//			img_pitchMarkings = ImageIO.read(getClass().getResource("/pfd/img_pitchMarkings.png"));
			...
			img_hdef_dots_a = ImageIO.read(getClass().getResource("/pfd/img_hdef_dots_a.png"));
			img_hdef_exp_loc = ImageIO.read(getClass().getResource("/pfd/img_hdef_exp_loc.png"));
			img_hdef_exp_loc_a = ImageIO.read(getClass().getResource("/pfd/img_hdef_exp_loc_a.png"));
			img_hdef_ind = ImageIO.read(getClass().getResource("/pfd/img_hdef_ind.png"));
			img_hdef_ind_filled = ImageIO.read(getClass().getResource("/pfd/img_hdef_ind_filled.png"));
			img_hdef_ind_ghost = ImageIO.read(getClass().getResource("/pfd/img_hdef_ind_ghost.png"));
			img_vdef_dots = ImageIO.read(getClass().getResource("/pfd/img_vdef_dots.png"));
			img_vdef_dots_a = ImageIO.read(getClass().getResource("/pfd/img_vdef_dots_a.png"));
			img_vdef_ind = ImageIO.read(getClass().getResource("/pfd/img_vdef_ind.png"));
			img_vdef_ind_filled = ImageIO.read(getClass().getResource("/pfd/img_vdef_ind_filled.png"));
			img_vdef_ind_ghost = ImageIO.read(getClass().getResource("/pfd/img_vdef_ind_ghost.png"));
			img_landing_alt_indicator = ImageIO.read(getClass().getResource("/pfd/img_landing_alt_indicator.png"));
			img_green_baro_bug = ImageIO.read(getClass().getResource("/pfd/img_green_baro_bug.png"));
			img_amber_baro_bug = ImageIO.read(getClass().getResource("/pfd/img_amber_baro_bug.png"));
			img_green_baro_pointer = ImageIO.read(getClass().getResource("/pfd/img_green_baro_pointer.png"));
			img_amber_baro_pointer = ImageIO.read(getClass().getResource("/pfd/img_amber_baro_pointer.png"));
			img_horiz_nps_scale = ImageIO.read(getClass().getResource("/pfd/img_horiz_nps_scale.png"));
			img_vert_nps_scale = ImageIO.read(getClass().getResource("/pfd/img_vert_nps_scale.png"));
			img_vert_nps_scale_2 = ImageIO.read(getClass().getResource("/pfd/img_vert_nps_scale_2.png"));
			...
			img_nd_dme = ImageIO.read(getClass().getResource("/nd/img_nd_dme.png"));
			img_nd_dme_tuned = ImageIO.read(getClass().getResource("/nd/img_nd_dme_tuned.png"));
			img_nd_dme_fix = ImageIO.read(getClass().getResource("/nd/img_nd_dme_fix.png"));
			img_nd_vor = ImageIO.read(getClass().getResource("/nd/img_nd_vor.png"));
			img_nd_vor_tuned = ImageIO.read(getClass().getResource("/nd/img_nd_vor_tuned.png"));
			img_nd_vor_fix = ImageIO.read(getClass().getResource("/nd/img_nd_vor_fix.png"));
			img_nd_vortac = ImageIO.read(getClass().getResource("/nd/img_nd_vortac.png"));
			img_nd_vortac_tuned = ImageIO.read(getClass().getResource("/nd/img_nd_vortac_tuned.png"));
			img_nd_vortac_fix = ImageIO.read(getClass().getResource("/nd/img_nd_vortac_fix.png"));
			img_nd_wpt = ImageIO.read(getClass().getResource("/nd/img_nd_wpt.png"));
			img_nd_wpt_fix = ImageIO.read(getClass().getResource("/nd/img_nd_wpt_fix.png"));
			//
			//img_top_mask = ImageIO.read(getClass().getResource("/nd/img_top_mask.png"));
//			img_compass_rose_text = ImageIO.read(getClass().getResource("/nd/img_compass_rose_text.png"));
			//img_compass_rose_mask = ImageIO.read(getClass().getResource("/nd/img_compass_rose_mask.png"));
//			img_compass_rose = ImageIO.read(getClass().getResource("/nd/img_compass_rose.png"));
			//img_heading_box = ImageIO.read(getClass().getResource("/nd/img_heading_box.png"));
			img_plane_triangle = ImageIO.read(getClass().getResource("/nd/img_plane_triangle.png"));
			img_plane_vor_symbol = ImageIO.read(getClass().getResource("/nd/img_plane_vor_symbol.png"));
			img_plane_pln = ImageIO.read(getClass().getResource("/nd/img_plane_pln.png"));
			//img_track_box = ImageIO.read(getClass().getResource("/nd/img_track_box.png"));
			//img_range_markers = ImageIO.read(getClass().getResource("/nd/img_range_markers.png"));
			img_ctr_compass_rose = ImageIO.read(getClass().getResource("/nd/img_ctr_compass_rose.png"));
			img_white_waypoint = ImageIO.read(getClass().getResource("/nd/img_white_waypoint.png"));
			img_magenta_waypoint = ImageIO.read(getClass().getResource("/nd/img_magenta_waypoint.png"));
			img_white_flyover_waypoint = ImageIO.read(getClass().getResource("/nd/img_white_flyover_waypoint.png"));
			img_magenta_flyover_waypoint = ImageIO.read(getClass().getResource("/nd/img_magenta_flyover_waypoint.png"));
			//img_pln_circles = ImageIO.read(getClass().getResource("/nd/img_pln_circles.png"));
//			img_pln_mask = ImageIO.read(getClass().getResource("/nd/img_pln_mask.png"));
//			img_selected_heading_bug = ImageIO.read(getClass().getResource("/nd/img_selected_heading_bug.png"));
//			img_selected_heading_line = ImageIO.read(getClass().getResource("/nd/img_selected_heading_line.png"));
//			img_track_line = ImageIO.read(getClass().getResource("/nd/img_track_line.png"));
//			img_heading_pointer = ImageIO.read(getClass().getResource("/nd/img_heading_pointer.png"));
//			img_wind_arrow = ImageIO.read(getClass().getResource("/nd/img_wind_arrow.png"));
			img_Adf1_Arrow = ImageIO.read(getClass().getResource("/nd/img_Adf1_Arrow.png"));
			img_Adf2_Arrow = ImageIO.read(getClass().getResource("/nd/img_Adf2_Arrow.png"));
			img_Vor1_Arrow = ImageIO.read(getClass().getResource("/nd/img_Vor1_Arrow.png"));
			img_Vor2_Arrow = ImageIO.read(getClass().getResource("/nd/img_Vor2_Arrow.png"));
			img_Vor1_Arrow_ctr = ImageIO.read(getClass().getResource("/nd/img_Vor1_Arrow_ctr.png"));
			img_Vor2_Arrow_ctr = ImageIO.read(getClass().getResource("/nd/img_Vor2_Arrow_ctr.png"));
			img_Adf1_Arrow_ctr = ImageIO.read(getClass().getResource("/nd/img_Adf1_Arrow_ctr.png"));
			img_Adf2_Arrow_ctr = ImageIO.read(getClass().getResource("/nd/img_Adf2_Arrow_ctr.png"));
			//img_Range_Arcs = ImageIO.read(getClass().getResource("/nd/img_Range_Arcs.png"));
			img_Selected_Course_Line = ImageIO.read(getClass().getResource("/nd/img_Selected_Course_Line.png"));
			img_Selected_Course_Line_ctr = ImageIO.read(getClass().getResource("/nd/img_Selected_Course_Line_ctr.png"));
			//
			img_tcas_amber_arrowdn = ImageIO.read(getClass().getResource("/nd/img_tcas_amber_arrowdn.png"));
			img_tcas_amber_arrowup = ImageIO.read(getClass().getResource("/nd/img_tcas_amber_arrowup.png"));
			img_tcas_ambercircle = ImageIO.read(getClass().getResource("/nd/img_tcas_ambercircle.png"));
			img_tcas_diamond = ImageIO.read(getClass().getResource("/nd/img_tcas_diamond.png"));
			img_tcas_red_arrowdn = ImageIO.read(getClass().getResource("/nd/img_tcas_red_arrowdn.png"));
			img_tcas_red_arrowup = ImageIO.read(getClass().getResource("/nd/img_tcas_red_arrowup.png"));
			img_tcas_redbox = ImageIO.read(getClass().getResource("/nd/img_tcas_redbox.png"));
			...
			img_hdg_fail = ImageIO.read(getClass().getResource("/failureflags/img_hdg_fail.png"));
			img_ias_dis = ImageIO.read(getClass().getResource("/failureflags/img_ias_dis.png"));
			img_ldg_alt_fail = ImageIO.read(getClass().getResource("/failureflags/img_ldg_alt_fail.png"));
			img_no_vspd = ImageIO.read(getClass().getResource("/failureflags/img_no_vspd.png"));
			img_vert_fail = ImageIO.read(getClass().getResource("/failureflags/img_vert_fail.png"));
			img_map_fail = ImageIO.read(getClass().getResource("/failureflags/img_map_fail.png"));
