...
package org.andreels.zhsi.ExtPlaneInterface.command;

import org.andreels.zhsi.ExtPlaneInterface.util.ArrayUtils;

public class DataRefCommand implements CommandMessage {

	public static enum DATAREF_ACTION {
		SET, SUBSCRIBE, UNSUBSCRIBE, CMD_ONCE, CMD_BEGIN, CMD_END
	}
	...
	private String buildCommand() {
		...
		if (DATAREF_ACTION.SUBSCRIBE.equals(this.action) && this.accuracy != null) {
